...
const PantallaFormularioJefe = ({ route, navigation }) => {
  const { boss } = route.params || {};
  const isEditing = !!boss;
  const { tema } = useTema();
  
  const { handleAddBoss, handleUpdateBoss } = useGestorJefes();
  ...
  const getDifficultyColor = (difficulty) => {
    switch (difficulty) {
      case 'Easy': return tema.success;
      case 'Medium': return tema.warning;
      case 'Hard': return tema.danger;
      case 'Very Hard': return tema.primary;
      default: return tema.textMuted;
    }
  };
          ...
          <Controller
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <View style={[styles.input, errors.name && styles.inputError]}>
                <Ionicons name="skull-outline" size={20} color={tema.textMuted} style={styles.inputIcon} />
                <TextInput
                  style={styles.textInput}
                  placeholder="Ej: Ornstein & Smough"
                  placeholderTextColor={tema.textMuted}
                  onBlur={onBlur}
          ...
          <Controller
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <View style={[styles.input, errors.location && styles.inputError]}>
                <Ionicons name="location-outline" size={20} color={tema.textMuted} style={styles.inputIcon} />
                <TextInput
                  style={styles.textInput}
          ...
          <Controller
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <View style={styles.input}>
                <Ionicons name="repeat-outline" size={20} color={tema.textMuted} style={styles.inputIcon} />
                <TextInput
                  style={styles.textInput}
                  placeholder="0"
                  placeholderTextColor={tema.textMuted}
          ...
          <Controller
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <View style={styles.textArea}>
                <Ionicons name="document-text-outline" size={20} color={tema.textMuted} style={styles.textAreaIcon} />
                <TextInput
...
export default PantallaFormularioJefe;
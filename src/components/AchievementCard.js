...
import { toggleAchievement } from '../store';
...
const AchievementCard = ({ achievement }) => {
  ...
  const handleToggleAchievement = () => {
    ...
    dispatch(toggleAchievement(achievement.id));
  };
    ...
    <View style={[
      ...
      <View style={styles.header}>
        <Ionicons 
          ...
          size={24} 
          color={achievement.completed ? theme.gold : theme.textMuted} 
        />
        ...
        >
          <Ionicons 
            ...
            size={28} 
            color={
              isDarkSoulAchievement ? theme.textMuted :
              achievement.completed ? theme.success : theme.textMuted
            } 
          />
        </TouchableOpacity>
      </View>
